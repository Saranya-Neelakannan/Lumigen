...
export default function LearnverseHero() {
  return (
    <section className="relative overflow-hidden py-20 bg-gradient-to-b from-sky-50 via-white to-indigo-50">
      ...
      <div className="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          <p className="inline-flex items-center gap-2 text-xs tracking-[0.2em] text-sky-600 uppercase">
            <span className="h-1.5 w-1.5 rounded-full bg-sky-500" />
            Products • Learnverse
          </p>
          <h1 className="text-4xl sm:text-5xl font-black leading-tight bg-clip-text text-transparent bg-gradient-to-r from-sky-700 via-indigo-700 to-fuchsia-600">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              className="inline-flex items-center justify-center px-6 py-3 rounded-full bg-gradient-to-r from-sky-500 to-fuchsia-500 text-white text-sm sm:text-base font-semibold shadow-[0_18px_45px_rgba(56,189,248,0.35)] hover:shadow-[0_22px_55px_rgba(236,72,153,0.35)] transition-transform hover:-translate-y-0.5"
              href="#demo"
            >
              Request demo
            </a>
            <a
              className="inline-flex items-center justify-center px-6 py-3 rounded-full border border-sky-200 bg-white/60 text-sky-700 text-sm sm:text-base font-medium backdrop-blur-md hover:bg-sky-50"
              href="#features"
            >
              Explore features
            </a>
          ...
          <div className="flex flex-wrap gap-6 pt-2 text-xs sm:text-sm text-slate-500">
            <div>
              <p className="font-semibold text-slate-700">For K‑12, Colleges & EdTech</p>
        ...
        <div className="relative flex justify-center md:justify-end mt-8 md:mt-0">
          ...
          <img
            ...
            className="relative w-full max-w-[380px] md:max-w-[460px] rounded-[2rem] object-cover shadow-[0_18px_60px_rgba(15,23,42,0.24)]"
          />
          {/* small floating pill */}
