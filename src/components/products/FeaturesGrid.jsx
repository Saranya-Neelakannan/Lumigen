// src/components/products/FeaturesGrid.jsx
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {FEATURES.map((f) => (
            ...
            >
              ...
              <h4 className="relative text-base font-semibold text-slate-900">
                {f.title}
              </h4>
              <p className="relative text-xs text-slate-600 mt-2 leading-relaxed">
                {f.desc}
              </p>
            </div>
          ))}
